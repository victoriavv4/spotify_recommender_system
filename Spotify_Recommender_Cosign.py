...
def run_recommendor(new_df):
    with open(r'transformer.pkl', "rb") as file:
        transformer=pickle.load(file)
        print("transformer loaded successfully...")

    with open(r'transformed_main_df.pkl', "rb") as file:
        transformed_main_df=pickle.load(file)
        print("the trasnformed main dataframe loaded successfully...")
...
if __name__=="__main__":
    ...
    # df_spotify = pd.read_csv(r'spotify_data.csv')
    ...
    recommended_songs.to_csv(r'recommended-songs.csv')
